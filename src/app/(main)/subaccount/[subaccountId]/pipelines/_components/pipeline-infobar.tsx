...
const PipeLineInfoBar = ({ pipeline, pipelines, subAccountId }: Props) => {
  ...
  const handleClickCreatePipeline = ()=>{
    setOpenModal(
        ...
        subheading="Pipelines allos you to group tickets into lanes and track your business process all in one place">
