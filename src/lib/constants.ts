...
export const pricingCards = [
  {
    title: "Essential",
    description: "Solución integral a precio accesible",
    price: "$49",
    duration: "month",
    highlight: "Everything in Starter, plus",
    features: ["15 subcuentas", "Miembros de equipo ilimitados"],
    priceId: "price_1OYxkqFj9oKEERu1NbKUxXxN",
  },
  {
    title: "Unlimited",
    description: "Sin restricciones ni limites. ¡Domina tu industria!",
    price: "$199",
    duration: "month",
    highlight: "Key features",
    features: ["24/7 Support team", "Subcuentas ilimitadas", "Miembros de equipo ilimitados"],
    priceId: "price_1OYxkqFj9oKEERu1KfJGWxgN",
  },
  {
    title: "Starter",
    description: "Prueba Monarc y descubre el potencial",
    price: "Gratis",
    duration: "",
    highlight: "Key features",
    features: ["3 Sub cuentas", "3 Miembros de equipo", "5 embudos de venta"],
    priceId: "",
  },
];
